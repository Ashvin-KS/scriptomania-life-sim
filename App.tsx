...
const App: React.FC = () => {
  ...
  const [activeSettingsTab, setActiveSettingsTab] = useState<'chat' | 'api' | 'templates' | 'profile'>('chat');
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setCreationScenarioId(e.target.value)}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        updateCurrentSession({ instructionId: e.target.value });
                        // Load the template into custom instruction editor
                        const selected = allTemplates.find(i => i.id === e.target.value);
                        if (selected) {
                          // Generate dynamic prompt with the template content
